...
namespace Util.Numerics {
  /// <summary>
  ///   Copyright by Christian Borck (borck@hotmail.de)
  /// </summary>
  public static class Mathh {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool SameSign(int a, int b, int c, int d, int e) {
      var posi = a>=0;
      return posi==(b>=0)
             &&posi==(c>=0)
             &&posi==(d>=0)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool SameSign(int a, int b, int c, int d, int e, int f, int g, int h, int i) {
      var posi = a>=0;
      return posi==(b>=0)
             &&posi==(c>=0)
             &&posi==(d>=0)
    ...
    /// <summary>
    ///   Unsigned modulo that works like module its results are always positive
    /// </summary>
    /// <param name="x"></param>
    /// <param name="m"></param>
    /// <returns></returns>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static byte LimitToByte(this double value) {
      return value<BYTE_MIN ? BYTE_MIN : (value>BYTE_MAX ? BYTE_MAX : (byte)value);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static byte LimitToByte(this float value) {
      return value<BYTE_MIN ? BYTE_MIN : (value>BYTE_MAX ? BYTE_MAX : (byte)value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Limit(this float value, float minValue, float maxValue) {
      return value<minValue ? minValue : (value>maxValue ? maxValue : value);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double Limit(this double value, double minValue, double maxValue) {
      return value<minValue ? minValue : (value>maxValue ? maxValue : value);
    }
    ...
    /// <param name="x2"></param>
    /// <returns></returns>
    public static int GetSad(this int[] x1, int[] x2) {
      var n = x1.Length;
      if (n!=x2.Length)
        throw new ArgumentException("x1 and x2 are not in the same length.");
      var result = 0;
    ...
    /// <param name="x2"></param>
    /// <returns></returns>
    public static double GetSse(this double[] x1, double[] x2) {
      var n = x1.Length;
      if (n!=x2.Length)
        throw new ArgumentException("x1 and x2 are not in the same length.");
      var result = .0;
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int GetSse(this int[] x1, int[] x2) {
      var n = x1.Length;
      //if (n != x2.Length)
      //  throw new ArgumentException("x1 and x2 are not in the same length.");
      var result = 0;
    ...
    /// <param name="x2"></param>
    /// <returns></returns>
    public static double GetMse(this int[] x1, int[] x2) {
      var n = x1.Length;
      if (n!=x2.Length)
        throw new ArgumentException("x1 and x2 are not in the same length.");
      var result = 0;
    ...
    /// <param name="x2"></param>
    /// <returns></returns>
    public static double GetMse(this double[] x1, double[] x2) {
      var n = x1.Length;
      if (n!=x2.Length)
        throw new ArgumentException("x1 and x2 are not in the same length.");
      var result = .0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double RadToDeg(double phi) {
      return 180/PI*phi;
    }
    ...
    public static double CosDeg(double angle) {
      return Math.Cos(PI/180*angle);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double SinDeg(double angle) {
      return Math.Sin(PI/180*angle);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Complex InterpolateBilinear(Complex p00, Complex p01, Complex p10, Complex p11, double ax, double ay) {
      return ((1-ax)*p00+ax*p01)*(1-ay)+((1-ax)*p10+ax*p11)*ay;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Complex InterpolatePolarBilinear(Complex p00, Complex p01, Complex p10, Complex p11, double ax,
      double ay) {
      return Complex.FromPolarCoordinates(
        ((1-ax)*p00.Magnitude+ax*p01.Magnitude)*(1-ay)+((1-ax)*p10.Magnitude+ax*p11.Magnitude)*ay,
        InterpolatePhase(InterpolatePhase(p00.Phase, p01.Phase, ax), InterpolatePhase(p10.Phase, p11.Phase, ax), ay));
      //((1 - ax) * p00.Phase + ax * p01.Phase) * (1 - ay) + ((1 - ax) * p10.Phase + ax * p11.Phase) * ay);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Complex InterpolateCartesianBilinear(Complex p00, Complex p01, Complex p10, Complex p11, double ax,
      double ay) {
      return new Complex(
        ((1-ax)*p00.Real+ax*p01.Real)*(1-ay)+((1-ax)*p10.Real+ax*p11.Real)*ay,
        ((1-ax)*p00.Imaginary+ax*p01.Imaginary)*(1-ay)+((1-ax)*p10.Imaginary+ax*p11.Imaginary)*ay);
    }
