...
namespace Util.IO.Serialization {
  ...
  public static class Crc {
    ...
    public static byte[] Crc16S(byte[] data) {
      ...
      return new[] { (byte)(register%256), (byte)(register/256) };
    }
    ...
    /// <returns>4 bytes of CRC checksum</returns>
    public static uint Crc32(byte[] data) {
      return data.Aggregate(0xffffffff, (current, t) => (current>>8)^CrCtab[(current&0xff)^t])^0xffffffff;
    }
    ...
    /// </summary>
    /// <param name="data">input data</param>
    /// <returns>8 bytes of CRC checksum</returns>
    public static ulong Crc64(byte[] data) {
      var crc = 0xffffffffffffffff;
      for (var i = 0; i<data.Length; i++)
        crc=Crc64Table[((uint)(crc>>56)^data[i])&0xff]^(crc<<8);
