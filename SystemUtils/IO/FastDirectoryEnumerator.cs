...
namespace Util.IO {
  ...
  public class FileData {
    ...
    internal FileData(string dir, Win32FindData findData) {
      ...
      Path=global::System.IO.Path.Combine(dir, findData.cFileName);
    }
      ...
      public bool MoveNext() {
        ...
        if (_mCurrentContext.SubdirectoriesToProcess==null) {
          if (_mHndFindFile==null) {
            ...
            _mHndFindFile=UnsafeNativeMethods.FindFirstFile(searchPath, _mWinFindData);
            retval=!_mHndFindFile.IsInvalid;
          } else {
            //Otherwise, find the next item.
            retval=UnsafeNativeMethods.FindNextFile(_mHndFindFile, _mWinFindData);
          }
        }
